...
#from serialIO import toggleCovotServo
    ...
    for x,y,w,h in faces:
        ...
        if probabilityValue>threshold:
            if classIndex==0:
                ...
                cv2.rectangle(imgOrignal,(x,y),(x+w,y+h),(11,199,255),2)
                cv2.rectangle(imgOrignal, (x,y-40),(x+w, y), (11,199,255),-2)
                cv2.putText(imgOrignal, str(get_className(classIndex)),(x,y-10), font, 0.75, (255,255,255),1, cv2.LINE_AA)
            elif classIndex==1:
                #toggleCovotServo(0)

                cv2.rectangle(imgOrignal,(x,y),(x+w,y+h),(255,128,0),2)
                cv2.rectangle(imgOrignal, (x,y-40),(x+w, y), (255,128,0),-2)
                cv2.putText(imgOrignal, str(get_className(classIndex)),(x,y-10), font, 0.75, (255,255,255),1, cv2.LINE_AA)
